...
/* 			 for (page=1;page<5;page++) {
    ...
    function infiniteScrollContent(page) {
		startPage = true;
    	if ($(location).attr('pathname') == '/lifeinfo/morekadoNewsList') {
	                ...
	                if(data.length>0){
	                      ...
	                      $.each(data,function(index,item){
	                  		...
	                  		if (item.imgurl == null) {
		                  		...
		                  		output += 'onerror="this.src=\'http://ph.kado.net/adcontent/content_file/0422ef20e472e70c4e6caab65a27cec1.png\';"></span>';
