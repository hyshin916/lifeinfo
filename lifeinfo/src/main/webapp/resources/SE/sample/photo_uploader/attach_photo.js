    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	sUploadURL= 'http://' + window.location.hostname + ':8080/lifeinfo/back/news/multiplePhotoUpload'; 	//upload URL
    	alert(sUploadURL);
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	        ...
 	        sCallback : '../../SE/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
